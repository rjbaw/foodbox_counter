...
from datasets import VOCDetection, CocoDataset, get_augumentation, detection_collate, Resizer, Normalizer, Augmenter, collater, CUSTOM_Dataset
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    image_sets = list()
    CUSTOM_CLASSES = list()
    train_image_sets = list()
    test_image_sets = list()
    for dataset_folder in os.listdir(args.dataset_root):
        image_sets.append(dataset_folder)
    for dataset_folder in image_sets:
        rootpath = os.path.join(args.dataset_root, dataset_folder)
        train_image_sets.append((dataset_folder, 'train'))
        test_image_sets.append((dataset_folder, 'test'))
    #    [(args.custom_dataset_name, 'train')]
#        for line in open(rootpath + '/' + 'classes.txt'):
#            CUSTOM_CLASSES.append(line.strip())
